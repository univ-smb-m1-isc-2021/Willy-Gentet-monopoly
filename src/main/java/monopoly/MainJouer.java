...
public class MainJouer {
	...
	public static void main(String[] args) {
	    ...
	    Gare gare1 = new Gare("monopoly.Gare Montparnasse");
	    Gare gare2 = new Gare("monopoly.Gare de lyon");
	    Gare gare3 = new Gare("monopoly.Gare du nord");
	    Gare gare4 = new Gare("monopoly.Gare Saint-Lazard");
		...
		Joueur willy = new Joueur("Willy");
		Joueur thomas = new Joueur("Thomas");
		Joueur djam = new Joueur("Djamel");
		p.ajouteJoueur(willy);
		p.ajouteJoueur(thomas);
		p.ajouteJoueur(djam);
